...
<%
	...
	<DIV ALIGN=LEFT>
		<P STYLE="margin-bottom: 0in"><b><h1>SET 2</h1></b><br><B>
			
			1) The _______ is a number or a set of numbers on which the cipher operates.
...
<INPUT TYPE=RADIO NAME="q1" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default
	...
	<DIV ALIGN=LEFT>
		...
		2) A(n) ______ is a keyless substitution cipher with N inputs and M outputs that uses a<br> formula to define the relationship between the input stream and the output stream.
...
<INPUT TYPE=RADIO NAME="q3" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default</P>
	...
	<DIV ALIGN=LEFT>
		<P STYLE="margin-bottom: 0in"><BR><B>
				...
				4) The ________ method provides a one-time session key for two parties.
...
<INPUT TYPE=RADIO NAME="q5" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default</P>
	...
	<DIV ALIGN=LEFT>
		...
		6.) This is the encryption algorithm that will begin to supplant the Data Encryption Standard (DES) - <br>and later Triple DES - over the next few years as the new standard encryption algorithm. 
...
<INPUT TYPE=RADIO NAME="q6" VALUE="default" CHECKED STYLE="width: 0.14in; height: 0.14in">Default
	...
	<DIV ALIGN=LEFT>
		...
		7) This is a trial and error method used to decode encrypted data through exhaustive <br>effort rather than employing intellectual strategies. 
...
<DIV ALIGN=LEFT>
	...
	8) Plain Text: Ethical hacking	<br>Clue: Ceasar&rsquo;s Cipher	( Use frequency analysis )
	...
	9) Plain Text :Haunted house	<br>Clue:  Rail Fence Cipher (Rail size: 3)
	...
	10) Insertion of messages into the network from a fraudulent source is a __________ attack.
	...
	12) When a user is computing the hash of a message and then encrypting the hash with his<br> private key, he is producing:
	...
	13)Key distribution often involves the use of _________ which are generated and distributed <br>or temporary use between two parties.
	...
	14) Use keyword cipher technique<br>
Plain Text : walk to remember  Keyword : magic<br>
Find cipher text.
	...
	15) DSS is a __________ technique.
	...
	16) Use columnar transposition. Keyword: zebras<br>
Plain Text : We are discovered. Find the cipher text.
	...
	17)  _________ cipher technique translates letters into numbers.
	...
	18) In a(n) ________ cipher, the same key is used by both the sender and receiver.
	...
	19) Key distribution often involves the use of _________ which are generated and <br>distributed for temporary use between two parties.
...
20) Use Playfair cipher.<br>
Plain Text: Under the tomb.	Keyword: Dragonite<br>
